...
# initialize empty cmd table
# initialize empty results table
# write a list of commands to run with the pool

# take all thar do not have result, and map/run to the thread pool
# run in many threads, and double-commit to the commands and to the results table

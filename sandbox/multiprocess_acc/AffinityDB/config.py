...
database_root = '/n/scratch2/xl198/affinity/profile/affinityDB'
...
#smina = 'smina.static'
smina = '/home/mdk24/program/smina/smina.static'

# pdb_target_list
# list_of_PDBs_to_download = os.path.join(sys.path[0],'target_list','main_pdb_target_list.txt')
list_of_PDBs_to_download = '/home/xl198/code/core/AffinityDB/target_list/main_pdb_target_list.txt'

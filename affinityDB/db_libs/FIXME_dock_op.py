...
# FIXME
# dock_init should take/accept smina parameters to work with
# dock should have not defaults, but simply run synthesized by dock_init text command
# FIXME: explanations of

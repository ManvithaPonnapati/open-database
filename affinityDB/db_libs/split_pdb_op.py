...
def split_pdb(split_pdb, cuttoff_dist = 8, min_rec_atoms=10,
    ...
    for chain, resnum, resname in ligs:
        ...
        assert len(np.intersect1d(lig_resnums,bindsite_resnums))==0,"broken selection: binding site and ligand overlap"
        ...
        pair_name = '_'.join([pdb_id, str(chain), str(resnum), str(resname)])

...
#smina = 'smina.static'
data_dir = '/Users/Will/projects/reformat/uptodate/data'
...
# example scoring
scoring_terms = os.path.join('/Users/Will/projects/reformat/uptodate/core/database/dataset_libs/VDS1', 'data', 'smina.score')
